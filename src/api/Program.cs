...
namespace API
{
    public class Program
    {
        ...
        private static void SeedDatabase(ApiDbContext context)
        {
            ...
            var projectLeads = new[] {"bob", "hugo"};
            var random = new Random();
            foreach (var customer in new[] {"Contoso", "Acme Corporation", "Globex Corporation"})
            {
                ...
                for (int j = 0; j < ProjectPerCustomer; j++)
                {
                    context.Projects.Add(new Project()
                    {
                        ...
                        , Name = $"Project {ProjectNames[random.Next(ProjectNames.Length)]}"
                        , ProjectLead = projectLeads[random.Next(projectLeads.Length)]
                    });
                }
            }
        ...
        private static string[] ProjectNames => new[]
        {
